...
<div id="layout-wrapper" class="w-full min-h-screen pb-48 flex flex-col items-center bg-zinc-900 px-6 sm:px-16 md:px-32 lg:px-42 font-['Google_Sans'] text-zinc-100">

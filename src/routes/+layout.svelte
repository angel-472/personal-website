...
<!-- SITE FOOTER -->
<footer class="w-full py-8 text-center text-gray-100 bg-gray-900 font-['Rubik'] flex flex-col items-center">
	<p class="text-sm">&copy; {new Date().getFullYear()} Angel Diaz. All rights reserved.</p>
	
	<div class="text-xs text-gray-300 p-4 w-2xs sm:w-lg">{weatherString}</div>
	<p class="mt-16 mb-4 text-xs text-gray-300 italic">Somewhere between thought<br>and the thing thought brings to life — <br>that's where I live now</p>
</footer>
...
<main aria-label="About page" class="w-full flex flex-col gap-8">
  ...
  <section class="flex flex-col gap-4 text-lg" aria-label="About Content">
    ...
    <ul class="list-inside text-gray-700">
      <li>
          <a href="https://github.com/angel-472" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2">
      ...
      <li>
        <a href="https://youtube.com/@diazadev" class="flex items-center gap-2" target="_blank" rel="noopener noreferrer">
          <svg class="size-5" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>YouTube</title><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
          YouTube
        </a>
      </li>

      <li>
        <a href="https://www.linkedin.com/in/angel-diaza" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2">
